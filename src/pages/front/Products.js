                ...
                return (
                  <div className="col-md-6" key={product.id}>
                    <Link
                      ...
                      className="productsList card border-0 mb-4 position-relative position-relative myHover p-2"
                    >
                      <img
